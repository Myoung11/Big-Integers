 /* Assisted by and Assisted line numbers: Dr.Su lines 69-164, 183-218
...
public:
    ...
    /*------------------------------------------------------------------------
     ...
     BigInt operator-(BigInt addend3);

    
    bool operator>(BigInt addend5);
    
    
    BigInt operator*(BigInt addend4);
